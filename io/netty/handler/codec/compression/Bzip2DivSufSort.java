...
final class Bzip2DivSufSort
{
  ...
  private void ssInsertionSort(int pa, int first, int last, int depth)
  {
    ...
    for (int i = last - 2; first <= i; i--)
    {
      int t = SA[i];
      int r;
      for (int j = i + 1; 0 < (r = ssCompare(pa + t, pa + SA[j], depth));)
      {
        do
        {
          SA[(j - 1)] = SA[j];
  ...
  private void ssFixdown(int td, int pa, int sa, int i, int size)
  {
    ...
    int j;
    int k;
    for (int c = T[(td + SA[(pa + v)])] & 0xFF; (j = 2 * i + 1) < size; i = k)
    {
  ...
  private void ssMultiKeyIntroSort(int pa, int first, int last, int depth)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          int a = first + 1;
          for (int v = T[(Td + SA[(pa + SA[first])])] & 0xFF; a < last; a++) {
        ...
        else
        {
          ...
          if (((a = b) < last) && (x < v)) {
            ...
            {
              b++;
              if ((b >= last) || ((x = T[(Td + SA[(pa + SA[b])])] & 0xFF) > v)) {
                break;
              }
              if (x == v)
              {
          ...
          for (; b < c; goto 752)
          {
            ...
            {
              b++;
              if ((b >= c) || ((x = T[(Td + SA[(pa + SA[b])])] & 0xFF) > v)) {
                break;
              }
              if (x == v)
              {
  ...
  private void subStringSort(int pa, int first, int last, int[] buf, int bufoffset, int bufsize, int depth, boolean lastsuffix, int size)
  {
    ...
    if (lastsuffix)
    {
      ...
      for (; (a < last) && ((SA[a] < 0) || (0 < (r = ssCompareLast(pa, pa + i, pa + SA[a], depth, size)))); a++) {
        SA[(a - 1)] = SA[a];
      }
      if (r == 0) {
        SA[a] ^= 0xFFFFFFFF;
  ...
  private void trFixdown(int isa, int isaD, int isaN, int sa, int i, int size)
  {
    ...
    int j;
    int k;
    for (int c = trGetC(isa, isaD, isaN, v); (j = 2 * i + 1) < size; i = k)
    {
      k = j++;
  ...
  private void trInsertionSort(int isa, int isaD, int isaN, int first, int last)
  {
    ...
    for (int a = first + 1; a < last; a++)
    {
      int t = SA[a];
      int r;
      for (int b = a - 1; 0 > (r = trGetC(isa, isaD, isaN, t) - trGetC(isa, isaD, isaN, SA[b]));)
      {
        do
        {
          SA[(b + 1)] = SA[b];
    ...
    for (;;)
    {
      ...
      else if (limit-- == 0)
      {
        ...
        for (int a = last - 1; first < a; a = b)
        {
          ...
          for (b = a - 1; (first <= b) && (trGetC(isa, isaD, isaN, SA[b]) == x); b--) {
            SA[b] ^= 0xFFFFFFFF;
          }
        }
        lsUpdateGroup(isa, first, last);
      ...
      else
      {
        ...
        if (((a = b) < last) && (x < v)) {
          ...
          {
            b++;
            if ((b >= last) || ((x = trGetC(isa, isaD, isaN, SA[b])) > v)) {
              break;
            }
            if (x == v)
            {
        ...
        for (; b < c; goto 609)
        {
          ...
          {
            b++;
            if ((b >= c) || ((x = trGetC(isa, isaD, isaN, SA[b])) > v)) {
              break;
            }
            if (x == v)
            {
  ...
  private int sortTypeBstar(int[] bucketA, int[] bucketB)
  {
    ...
    for (i = m - 2; 0 <= i; i--)
    {
      ...
      c0 = T[t] & 0xFF;
      int c1 = T[(t + 1)] & 0xFF;
      SA[(bucketB[BUCKET_BSTAR(c0, c1)] -= 1)] = i;
    }
    int t = SA[(PAb + m - 1)];
    c0 = T[t] & 0xFF;
    int c1 = T[(t + 1)] & 0xFF;

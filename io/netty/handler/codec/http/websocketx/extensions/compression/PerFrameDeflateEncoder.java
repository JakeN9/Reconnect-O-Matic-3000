  ...
  extends DeflateEncoder
{
  ...
  public boolean acceptOutboundMessage(Object msg)
    throws Exception
  {
    return (((msg instanceof TextWebSocketFrame)) || ((msg instanceof BinaryWebSocketFrame)) || ((msg instanceof ContinuationWebSocketFrame))) && (((WebSocketFrame)msg).content().readableBytes() > 0) && ((((WebSocketFrame)msg).rsv() & 0x4) == 0);
  }

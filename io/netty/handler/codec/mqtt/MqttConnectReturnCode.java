...
{
  CONNECTION_ACCEPTED((byte)0),  CONNECTION_REFUSED_UNACCEPTABLE_PROTOCOL_VERSION((byte)1),  CONNECTION_REFUSED_IDENTIFIER_REJECTED((byte)2),  CONNECTION_REFUSED_SERVER_UNAVAILABLE((byte)3),  CONNECTION_REFUSED_BAD_USER_NAME_OR_PASSWORD((byte)4),  CONNECTION_REFUSED_NOT_AUTHORIZED((byte)5);
  ...
  {
    if (valueToCodeMap.containsKey(Byte.valueOf(b))) {
      return (MqttConnectReturnCode)valueToCodeMap.get(Byte.valueOf(b));
    }
